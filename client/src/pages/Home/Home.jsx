    ...
    <div className={styles.home}>
      <div className={styles.hero}>
        <div className={styles.hero_content}>
          <h1 className={styles.hero_title}>Добро пожаловать <br />в салон красоты «ATMOSФEPA»</h1>
          ...
          {promotions.length > 0 && (
            <div className={styles.slider_container}>
              <button
                ...
                onClick={handlePromotionsPrev}
                disabled={promotionsSlide === 0 || promotions.length <= slidesToShow}
              >
                <FiChevronLeft />
              </button>
              ...
              <button
                ...
                onClick={handlePromotionsNext}
                disabled={promotionsSlide >= promotions.length - slidesToShow || promotions.length <= slidesToShow}
              >
                <FiChevronRight />
              </button>
            </div>
      ...
      <div className={`${styles.section} ${styles.section_gray}`}>
        <div className='container'>
          ...
          {reviews.length > 0 && (
            <div className={styles.slider_container}>
              <button className={`${styles.slider_arrow} ${styles.slider_arrow_left}`} onClick={handleReviewPrev} disabled={reviewSlide === 0}>
                <FiChevronLeft />
              </button>
              ...
              <button className={`${styles.slider_arrow} ${styles.slider_arrow_right}`} onClick={handleReviewNext} disabled={reviewSlide >= reviews.length - slidesToShow}>
                <FiChevronRight />
              </button>
            </div>
          )}
